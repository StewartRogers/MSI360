...
export const ko: Translation = {
  ...
  questions: {
    ...
    "question-3": {
      ...
      help_text:
        "평가하려는 특정 업무 또는 활동을 간단히 설명해 주세요. 해당되는 경우 자세, 불편함, 작업대 인체공학, 휴식 시간 등의 세부 정보를 포함해 주세요."
    },
    "question-4": {
    ...
    "question-10": {
      label:
        "아래 표를 사용하여 평가 중인 직무 또는 업무를 수행하는 동안 또는 수행한 후 업무와 관련된 통증이나 불편함을 경험한 특정 신체 부위를 표시해 주세요.\n\na) 몸의 한쪽 또는 양쪽이 관련되었는지, b) 통증이 2일 이상 지속되었는지 표시해 주세요.",
      groups: {
        neck: { label: "1. 목", options: bodySideOptions },
        shoulders_upper_arms: { label: "2. 어깨 또는 상완", options: bodySideOptions },
        elbows_forearms: { label: "3. 팔꿈치 또는 전완", options: bodySideOptions },
        wrists_hands_fingers: { label: "4. 손목, 손 또는 손가락", options: bodySideOptions },
        lower_back: { label: "5. 허리", options: bodySideOptions },
        hips_upper_legs: { label: "6. 엉덩이 또는 허벅지", options: bodySideOptions },
        knees_lower_legs: { label: "7. 무릎 또는 종아리", options: bodySideOptions },
        ankles_feet: { label: "8. 발목 또는 발", options: bodySideOptions }
      }
    },
    "question-11": {
      label:
        "일반적인 근무일을 생각해 보세요. 또는 특정 업무나 활동을 평가하는 경우 그 업무를 수행하는 근무일의 해당 시간을 생각해 보세요. 날카로운 물체나 모서리에 몸의 일부를 기대거나 올려놓는 시간이 얼마나 됩니까?",
      options: {
    ...
    "question-13": {
      label:
        "한 번에 30분 넘게 잡고 있는 도구나 물체의 유형을 생각해 보세요. 아래 설명 목록에서 해당되는 내용을 모두 선택해 주세요.\n\n다른 옵션이 선택된 경우 마지막 옵션은 선택할 수 없습니다.",
      options: {
    ...
    "question-14": {
      label:
        "업무를 완료하기 위해 신체 일부를 임시 도구처럼 사용합니까? 예를 들어 손바닥이나 무릎으로 표면에 힘을 가할 수 있습니다.\n\n아래 그림은 이런 방식으로 몸을 사용하는 예입니다.",
      options: {
    ...
    "question-15": {
      label:
        "오늘 평가하는 직무, 업무 또는 작업 활동 중 물체를 밀거나 당기거나 이동시키는 표면의 종류를 생각해 보세요. 아래 설명 목록에서 해당되는 내용을 모두 선택해 주세요.",
      options: {
    ...
    "question-20": {
      label:
        "일반적인 근무일을 생각해 보세요. 또는 특정 업무나 활동을 평가하는 경우 그 업무를 수행하는 근무일의 해당 시간을 생각해 보세요. 앉거나 서 있을 때 상체를 앞으로, 뒤로 또는 옆으로 기울인 상태로 얼마나 자주 작업합니까?\n\n해당되는 옵션을 선택해 주세요.",
      groups: {
        forward_backward: { label: "앞이나 뒤로 15도 이상 기울입니다", options: mostSomeNeverOptions },
        sideways: { label: "옆으로 기울입니다", options: mostSomeNeverOptions }
      }
    },
    "question-21": {
    ...
    "question-22": {
      label:
        "일반적인 근무일을 생각해 보세요. 또는 특정 업무나 활동을 평가하는 경우 그 업무를 수행하는 근무일의 해당 시간을 생각해 보세요. 앉거나 서 있을 때 손이 몸에 비해 어디에 위치하는지 표시해 주세요.\n\n해당되는 옵션을 선택해 주세요.",
      groups: {
        hands_above_shoulders: { label: "손이 어깨보다 위에 있음", options: mostSomeNeverOptions },
        hands_floor_to_knee: { label: "손이 바닥과 무릎 사이에 있음", options: mostSomeNeverOptions }
      }
    },
    "question-23": {
    ...
    "question-29": {
      label:
        "일반적인 근무일을 생각해 보세요. 또는 특정 업무나 활동을 평가하는 경우 그 업무를 수행하는 근무일의 해당 시간을 생각해 보세요. 비슷한 동작을 반복해서 수행하는 데 얼마나 많은 시간을 보냅니까?",
      options: {
        less_than_30_min: "하루 30분 미만",
    ...
    "question-33": {
      label:
        "엄지와 손끝 사이로 물체를 잡는 것을 핀치 그립이라고 합니다. 오늘 평가하는 직무, 업무 또는 작업 활동 중 2파운드 / 1kg보다 무거운 물체를 핀치 그립으로 잡는 시간이 얼마나 됩니까?",
      options: {
    ...
    "question-34": {
      label:
        "손으로 물체를 감싸 쥐는 것을 파워 그립이라고 합니다. 10파운드 / 4.5kg보다 무거운 물체를 파워 그립으로 잡는 시간이 얼마나 됩니까?",
      options: {
        less_than_2_hours: "하루 2시간 미만",
        more_than_2_hours: "하루 2시간 초과",
        none: "전혀 없음"
    ...
    "question-36": {
      label:
        "80파운드 / 36kg보다 무거운 물건을 밀거나 당기는 경우, 자갈, 타일, 고르지 않은 지면 같은 거친 표면이나 모래, 진흙, 잔디 같은 부드러운 표면 위에서 이러한 물건을 이동하는 시간이 얼마나 됩니까?",
      options: {
        less_than_5_min: "하루 5분 미만",
    ...
    "question-37": {
      label:
        "일반적인 근무일을 생각해 보세요. 또는 특정 업무나 활동을 평가하는 경우 그 업무를 수행하는 근무일의 해당 시간을 생각해 보세요. 사이렌, 큰 대화 소리, 교통 소음 등으로 주의가 산만해지는 경우가 있습니까?",
      options: {
        frequently: "자주",
        sometimes: "가끔",
        no: "아니요"
