...
export const fil: Translation = {
  ...
  questions: {
    ...
    "question-10": {
      label: "Gamit ang talahanayan sa ibaba, pakisaad ang partikular na bahagi ng katawan kung saan ka nakaranas ng pananakit o hindi komportableng pakiramdam na kaugnay ng trabaho habang ginagawa o pagkatapos gawin ang trabahong o gawaing tinatasa.\n\nIsaad kung a) isang bahagi o parehong bahagi ng katawan ang apektado, at b) tumagal ang pananakit nang 2 araw o higit pa.",
      groups: {
        neck: {
          label: "1. Leeg",
          options: {
        ...
        shoulders_upper_arms: {
          label: "2. Balikat o itaas na braso",
          options: {
            one_side: "Pananakit o hindi komportable sa isang bahagi ng katawan, halimbawa kaliwa o kanan",
            both_sides: "Pananakit o hindi komportable sa parehong kaliwa at kanan",
            lasted_two_days: "Ang pananakit ay tumagal nang 2 araw o higit pa"
        ...
        wrists_hands_fingers: {
          label: "4. Pulso, kamay, o mga daliri",
          options: {
            one_side: "Pananakit o hindi komportable sa isang bahagi ng katawan, halimbawa kaliwa o kanan",
            both_sides: "Pananakit o hindi komportable sa parehong kaliwa at kanan",
            lasted_two_days: "Ang pananakit ay tumagal nang 2 araw o higit pa"
        ...
        hips_upper_legs: {
          label: "6. Balakang o itaas na binti",
          options: {
            one_side: "Pananakit o hindi komportable sa isang bahagi ng katawan, halimbawa kaliwa o kanan",
            both_sides: "Pananakit o hindi komportable sa parehong kaliwa at kanan",
            lasted_two_days: "Ang pananakit ay tumagal nang 2 araw o higit pa"
    ...
    "question-11": {
      label: "Isipin ang karaniwang araw ng trabaho, o kung tinatasa mo ang isang partikular na gawain o aktibidad, ang bahagi ng araw kung kailan ginagawa mo iyon. Gaano katagal kang nakasandal o nakapatong ang bahagi ng katawan mo sa matutulis na bagay o gilid?",
      options: {
    ...
    "question-13": {
      label: "Isipin ang mga uri ng tool o bagay na hinahawakan mo nang higit sa 30 minuto sa bawat pagkakataon. Mula sa listahan sa ibaba, piliin ang lahat ng pahayag na naaangkop sa mga item na ito.\n\nHindi maaaring piliin ang huling opsyon kung may iba pang opsyon na na-tick.",
      options: {
    ...
    "question-14": {
      label: "Gumagamit ka ba ng anumang bahagi ng katawan bilang pansamantalang tool para matapos ang trabaho? Halimbawa, maaari mong gamitin ang palad o tuhod para maglapat ng puwersa sa isang ibabaw.\n\nAng ilustrasyon sa ibaba ay halimbawa ng paggamit ng katawan sa ganitong paraan.",
      options: {
    ...
    "question-15": {
      label: "Isipin ang mga uri ng ibabaw kung saan ka nagtutulak, humihila, o naglilipat ng mga bagay sa trabahong, gawain, o aktibidad na tinatasa mo ngayon. Mula sa listahan sa ibaba, piliin ang lahat ng pahayag na naaangkop sa mga ibabaw na ito.",
      options: {
    ...
    "question-20": {
      label: "Isipin ang karaniwang araw ng trabaho, o kung tinatasa mo ang isang partikular na gawain o aktibidad, ang bahagi ng araw kung kailan ginagawa mo iyon. Kapag nakaupo o nakatayo, gaano kadalas kang nagtatrabaho na nakahilig ang itaas na bahagi ng katawan mo pasulong, paatras, o patagilid?\n\nPiliin ang mga opsyong naaangkop sa iyo.",
      groups: {
        forward_backward: {
          label: "Humihilig ako pasulong o paatras nang higit sa 15 degrees",
          options: {
            most: "Karamihan ng oras",
            some: "Ilang bahagi ng oras",
            never: "Hindi kailanman"
    ...
    "question-22": {
      label: "Isipin ang karaniwang araw ng trabaho, o kung tinatasa mo ang isang partikular na gawain o aktibidad, ang bahagi ng araw kung kailan ginagawa mo iyon. Kapag nakaupo o nakatayo, pakisaad kung nasaan ang mga kamay mo kaugnay ng katawan mo.\n\nPiliin ang mga opsyong naaangkop sa iyo.",
      groups: {
        hands_above_shoulders: {
          label: "Mga kamay na nasa taas ng balikat",
          options: {
            most: "Karamihan ng oras",
            some: "Ilang bahagi ng oras",
            never: "Hindi kailanman"
        ...
        hands_floor_to_knee: {
          label: "Mga kamay na nasa pagitan ng sahig at tuhod",
          options: {
            most: "Karamihan ng oras",
            some: "Ilang bahagi ng oras",
            never: "Hindi kailanman"
    ...
    "question-29": {
      label: "Isipin ang karaniwang araw ng trabaho, o kung tinatasa mo ang isang partikular na gawain o aktibidad, ang bahagi ng araw kung kailan ginagawa mo iyon. Gaano katagal kang gumagawa ng magkakatulad na galaw nang paulit-ulit?",
      options: {
        less_than_30_min: "Mas mababa sa 30 minuto sa isang araw",
    ...
    "question-33": {
      label: "Kapag hinahawakan mo ang isang bagay sa pagitan ng hinlalaki at dulo ng mga daliri, tinatawag itong pinch grip. Kapag ginagawa mo ang trabahong, gawain, o aktibidad na tinatasa mo ngayon, gaano katagal kang gumagamit ng pinch grip para hawakan ang bagay na mas mabigat sa 2 pounds / 1 kg?",
      options: {
    ...
    "question-37": {
      label: "Isipin ang karaniwang araw ng trabaho, o kung tinatasa mo ang isang partikular na gawain o aktibidad, ang bahagi ng araw kung kailan ginagawa mo iyon. Nadidistract ka ba minsan ng mga ingay (sirena, malakas na usapan, trapiko, atbp.)?",
      options: {
        frequently: "Madalas",
