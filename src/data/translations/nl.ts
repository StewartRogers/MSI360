...
export const nl: Translation = {
  app: {
    ...
    description_body:
      "De volgende vragen gaan over het werk dat je doet tijdens een typische werkdag, of wanneer je de specifieke taak of activiteit uitvoert die je vandaag wilt beoordelen. Het doel is dat je MSI360 vertelt welke handelingen je uitvoert om je werk gedaan te krijgen."
  },
  sections: {
    intro: "Over het werk",
  ...
  questions: {
    ...
    "question-10": {
      label:
        "Geef met de onderstaande tabel aan in welke specifieke lichaamsdelen je werkgerelateerde pijn of ongemak hebt ervaren tijdens of na het uitvoeren van de beoordeelde functie of taak.\n\nGeef aan of a) een of beide zijden van je lichaam betrokken waren, en b) de pijn 2 dagen of langer duurde.",
      groups: {
        neck: { label: "1. Nek", options: bodySideOptions },
        shoulders_upper_arms: { label: "2. Schouders of bovenarmen", options: bodySideOptions },
        elbows_forearms: { label: "3. Ellebogen of onderarmen", options: bodySideOptions },
        wrists_hands_fingers: { label: "4. Polsen, handen of vingers", options: bodySideOptions },
        lower_back: { label: "5. Onderrug", options: bodySideOptions },
        hips_upper_legs: { label: "6. Heupen of bovenbenen", options: bodySideOptions },
        knees_lower_legs: { label: "7. Knieen of onderbenen", options: bodySideOptions },
        ankles_feet: { label: "8. Enkels of voeten", options: bodySideOptions }
      }
    },
    "question-11": {
      label:
        "Denk aan een typische werkdag, of aan het deel van de werkdag waarin je de specifieke taak uitvoert die je beoordeelt. Hoeveel tijd besteed je aan leunen of rusten met een deel van je lichaam op scherpe voorwerpen of randen?",
      options: {
    ...
    "question-13": {
      label:
        "Denk aan de soorten gereedschap of voorwerpen die je langer dan 30 minuten achter elkaar vasthoudt. Selecteer uit de onderstaande beschrijvingen alles wat van toepassing is.\n\nDe laatste optie kan niet worden gekozen als een andere optie is aangevinkt.",
      options: {
    ...
    "question-14": {
      label:
        "Gebruik je een lichaamsdeel als hulpmiddel om je werk af te maken? Je kunt bijvoorbeeld je handpalm of knie gebruiken om kracht op een oppervlak uit te oefenen.\n\nDe afbeelding hieronder toont een voorbeeld van dit soort gebruik van je lichaam.",
      options: {
    ...
    "question-15": {
      label:
        "Denk aan de soorten oppervlakken waarover je voorwerpen duwt, trekt of verplaatst tijdens de functie, taak of werkactiviteit die je vandaag beoordeelt. Selecteer alle beschrijvingen die van toepassing zijn.",
      options: {
    ...
    "question-20": {
      label:
        "Denk aan een typische werkdag, of aan het deel van de werkdag waarin je de specifieke taak uitvoert die je beoordeelt. Hoe vaak werk je zittend of staand met je bovenlichaam naar voren, naar achteren of zijwaarts gebogen?\n\nSelecteer de opties die op jou van toepassing zijn.",
      groups: {
        forward_backward: { label: "Ik buig meer dan 15 graden naar voren of naar achteren", options: mostSomeNeverOptions },
        sideways: { label: "Ik buig zijwaarts", options: mostSomeNeverOptions }
      }
    },
    "question-21": {
    ...
    "question-22": {
      label:
        "Denk aan een typische werkdag, of aan het deel van de werkdag waarin je de specifieke taak uitvoert die je beoordeelt. Geef aan waar je handen zich bevinden ten opzichte van je lichaam wanneer je zit of staat.\n\nSelecteer de opties die op jou van toepassing zijn.",
      groups: {
        hands_above_shoulders: { label: "Handen boven schouderhoogte", options: mostSomeNeverOptions },
        hands_floor_to_knee: { label: "Handen tussen vloer en knie", options: mostSomeNeverOptions }
      }
    },
    "question-23": {
    ...
    "question-29": {
      label:
        "Denk aan een typische werkdag, of aan het deel van de werkdag waarin je de specifieke taak uitvoert die je beoordeelt. Hoeveel tijd besteed je aan het steeds opnieuw uitvoeren van vergelijkbare bewegingen?",
      options: {
        less_than_30_min: "Minder dan 30 minuten per dag",
    ...
    "question-33": {
      label:
        "Wanneer je een voorwerp tussen je duim en vingertoppen vastpakt, heet dat een pincetgreep. Hoeveel tijd besteed je tijdens de functie, taak of werkactiviteit die je vandaag beoordeelt aan het gebruiken van een pincetgreep om een object vast te houden dat zwaarder is dan 2 pond / 1 kg?",
      options: {
    ...
    "question-34": {
      label:
        "Wanneer je je hand om een object heen sluit om het vast te houden, heet dat een krachtgreep. Hoeveel tijd besteed je aan het gebruiken van een krachtgreep om een object vast te houden dat zwaarder is dan 10 pond / 4,5 kg?",
      options: {
        less_than_2_hours: "Minder dan 2 uur per dag",
        more_than_2_hours: "Meer dan 2 uur per dag",
        none: "Helemaal geen tijd"
    ...
    "question-36": {
      label:
        "Als je voorwerpen duwt of trekt die zwaarder zijn dan 80 pond / 36 kg, hoeveel tijd besteed je aan het verplaatsen ervan over ruwe oppervlakken, zoals grind, tegels of ongelijke grond, of zachte oppervlakken, zoals zand, modder of gras?",
      options: {
        less_than_5_min: "Minder dan 5 minuten per dag",
    ...
    "question-37": {
      label:
        "Denk aan een typische werkdag, of aan het deel van de werkdag waarin je de specifieke taak uitvoert die je beoordeelt. Word je ooit afgeleid door geluiden, zoals sirenes, hard praten, verkeer, enz.?",
      options: {
        frequently: "Vaak",
        sometimes: "Soms",
        no: "Nee"
