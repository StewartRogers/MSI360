...
export const fr: Translation = {
  ...
  questions: {
    ...
    "question-3": {
      ...
      help_text: "Veuillez fournir une brève description de la tâche ou de l'activité précise que vous souhaitez évaluer, y compris, s'il y a lieu, des détails sur la posture, l'inconfort, l'ergonomie du poste de travail et/ou la durée des pauses."
    },
    "question-4": {
    ...
    "question-10": {
      label: "À l'aide du tableau ci-dessous, veuillez indiquer les parties du corps où vous avez ressenti une douleur ou un inconfort lié au travail pendant ou après l'exécution de l'emploi ou de la tâche évalué.\n\nIndiquez si a) un seul côté ou les deux côtés de votre corps étaient touchés, et b) si la douleur a duré 2 jours ou plus.",
      groups: {
        neck: {
          label: "1. Cou",
          options: {
        ...
        shoulders_upper_arms: {
          label: "2. Épaules ou haut des bras",
          options: {
            one_side: "Douleur ou inconfort d'un seul côté, par exemple le côté gauche ou droit du corps",
            both_sides: "Douleur ou inconfort des deux côtés, gauche et droit",
            lasted_two_days: "La douleur a duré 2 jours ou plus"
        ...
        wrists_hands_fingers: {
          label: "4. Poignets, mains ou doigts",
          options: {
            one_side: "Douleur ou inconfort d'un seul côté, par exemple le côté gauche ou droit du corps",
            both_sides: "Douleur ou inconfort des deux côtés, gauche et droit",
            lasted_two_days: "La douleur a duré 2 jours ou plus"
        ...
        hips_upper_legs: {
          label: "6. Hanches ou haut des jambes, cuisses",
          options: {
            one_side: "Douleur ou inconfort d'un seul côté, par exemple le côté gauche ou droit du corps",
            both_sides: "Douleur ou inconfort des deux côtés, gauche et droit",
            lasted_two_days: "La douleur a duré 2 jours ou plus"
        ...
        knees_lower_legs: {
          label: "7. Genoux ou bas des jambes, mollets",
          options: {
            one_side: "Douleur ou inconfort d'un seul côté, par exemple le côté gauche ou droit du corps",
            both_sides: "Douleur ou inconfort des deux côtés, gauche et droit",
            lasted_two_days: "La douleur a duré 2 jours ou plus"
    ...
    "question-11": {
      label: "Pensez à une journée de travail typique ou, si vous évaluez une tâche ou une activité précise, à la partie de la journée où vous l'effectuez. Combien de temps passez-vous à appuyer ou à reposer une partie de votre corps sur des objets ou des bords tranchants?",
      options: {
    ...
    "question-13": {
      label: "Veuillez penser aux types d'outils ou d'objets que vous tenez pendant plus de 30 minutes à la fois. Dans la liste ci-dessous, sélectionnez toutes les descriptions qui s'appliquent à ces objets.\n\nLa dernière option ne peut pas être sélectionnée si d'autres options ont été cochées.",
      options: {
    ...
    "question-14": {
      label: "Utilisez-vous une partie de votre corps comme outil de fortune pour accomplir votre travail? Par exemple, vous pourriez utiliser votre paume ou votre genou pour appliquer une force sur une surface.\n\nL'illustration ci-dessous montre un exemple de cette utilisation du corps.",
      options: {
    ...
    "question-15": {
      label: "Pensez aux types de surfaces sur lesquelles vous poussez, tirez ou déplacez des objets pendant l'emploi, la tâche ou l'activité de travail que vous évaluez aujourd'hui. Dans la liste ci-dessous, sélectionnez toutes les descriptions qui s'appliquent à ces surfaces.",
      options: {
    ...
    "question-20": {
      label: "Pensez à une journée de travail typique ou, si vous évaluez une tâche ou une activité précise, à la partie de la journée où vous l'effectuez. Lorsque vous êtes assis ou debout, à quelle fréquence travaillez-vous avec le haut du corps penché vers l'avant, vers l'arrière ou sur le côté?\n\nVeuillez sélectionner les options qui s'appliquent à vous.",
      groups: {
        forward_backward: {
          label: "Je me penche vers l'avant ou vers l'arrière de plus de 15 degrés",
          options: {
            most: "La plupart du temps",
            some: "Une partie du temps",
            never: "Jamais"
        ...
        sideways: {
          label: "Je me penche sur le côté",
          options: {
            most: "La plupart du temps",
            some: "Une partie du temps",
            never: "Jamais"
    ...
    "question-22": {
      label: "Pensez à une journée de travail typique ou, si vous évaluez une tâche ou une activité précise, à la partie de la journée où vous l'effectuez. Lorsque vous êtes assis ou debout, veuillez indiquer où se trouvent vos mains par rapport à votre corps.\n\nVeuillez sélectionner les options qui s'appliquent à vous.",
      groups: {
        hands_above_shoulders: {
          label: "Mains au-dessus des épaules",
          options: {
            most: "La plupart du temps",
            some: "Une partie du temps",
            never: "Jamais"
        ...
        hands_floor_to_knee: {
          label: "Mains entre le sol et le genou",
          options: {
            most: "La plupart du temps",
            some: "Une partie du temps",
            never: "Jamais"
    ...
    "question-29": {
      label: "Pensez à une journée de travail typique ou, si vous évaluez une tâche ou une activité précise, à la partie de la journée où vous l'effectuez. Combien de temps passez-vous à effectuer des mouvements semblables encore et encore?",
      options: {
        less_than_30_min: "Moins de 30 minutes par jour",
    ...
    "question-34": {
      label: "Lorsque vous enroulez votre main autour d'un objet pour le tenir, on appelle cela une prise de force. Combien de temps passez-vous à utiliser une prise de force pour tenir un objet de plus de 10 lb / 4,5 kg?",
      options: {
        less_than_2_hours: "Moins de 2 heures par jour",
        more_than_2_hours: "Plus de 2 heures par jour",
        none: "Aucun temps"
    ...
    "question-36": {
      label: "Si vous poussez ou tirez des articles de plus de 80 lb / 36 kg, combien de temps passez-vous à les déplacer sur des surfaces rugueuses, comme du gravier, de la tuile ou un sol inégal, ou sur des surfaces molles, comme du sable, de la boue ou du gazon?",
      options: {
        less_than_5_min: "Moins de 5 minutes par jour",
    ...
    "question-37": {
      label: "Pensez à une journée de travail typique ou, si vous évaluez une tâche ou une activité précise, à la partie de la journée où vous l'effectuez. Êtes-vous parfois distrait par des bruits, comme des sirènes, des conversations fortes, la circulation, etc.?",
      options: {
