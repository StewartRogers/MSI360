...
export const en: Translation = {
  "app": {
    ...
    "score_summary_title": "Your MSI risk summary",
    "score_overall_risk": "Overall MSI Risk",
    "score_download_report": "Download Report",
    "score_not_available": "N/A",
    "score_out_of_4": "{score} out of 4",
    "score_risk_not_enough": "Not enough data",
    "score_risk_low": "Low risk",
    "score_risk_possible": "Possible risk",
    "score_risk_likely": "Likely risk",
    "score_risk_known": "Known risk",
    "score_factor_not_enough": "Not enough data to interpret {factor}.",
    "score_factor_low": "Currently low risk associated with {factor}.",
    "score_factor_possible": "Possible risk of discomfort from {factor}.",
    "score_factor_likely": "Likely risk of discomfort from {factor}.",
    "score_factor_known": "Known risk of pain and/or injury.",
    "score_psychosocial_note": "Psychosocial factors negatively influenced the overall MSI risk score ({multiplier}).",
    "score_subject_contact_stress": "contact stress",
    "score_subject_force": "force",
    "score_subject_awkward_postures": "awkward postures",
    "score_subject_repetition": "repetition",
    "score_subject_environmental": "environmental factors",
    "wrap_email_copy": "Email Copy",
    "wrap_review_results": "Review Results",
    "wrap_submit_report": "Submit Report",
    "email_title": "Get Your Report by Email",
    ...
    "report_task_label": "Job/task analyzed:",
    "report_overall_score_label": "Overall score:",
    "report_highest_risk": "Highest risk categories:",
    "report_no_scored_categories": "No scored risk categories yet",
    "report_email_copy_requested": "Email copy requested for {email}.",
    "report_download_pdf": "Download PDF",
    "report_email_report": "Email Report",
    "report_done": "Done",
    "submit_title": "Would you like to complete another ErgoCheck assessment?",
    "submit_option_reuse": "Yes, and I'd like to complete another report using the same information I provided initially allowing me to edit as needed.",
    "submit_option_restart": "Yes, and I'd like to start over with new information",
    "submit_option_no": "No, not right now",
    "submit_copy": "Thank you, please press the button below to finish the survey.",
    "submit_button": "Submit",
    "complete_title": "Thank You For Completing The MSI 360 Survey",
    "complete_body": "Your responses help identify MSI-related hazards in your workplace and contribute to a safer work environment for everyone.",
    "complete_next_steps_title": "Next Steps:",
    "complete_next_step_review": "Review your report and recommendations",
    "complete_next_step_share": "Share findings with your supervisor if appropriate",
  ...
  "questions": {
    ...
    "question-10": {
      "label": "Using the table below, please indicate the specific body parts where you have experienced work-related pain or discomfort during or after performing the job or task being assessed.\n\nIndicate whether a) one or both sides of your body were involved, and b) the pain lasted for 2 or more days.",
      "groups": {
        "neck": {
          "label": "1. Neck",
          "options": {
    ...
    "question-11": {
      "label": "Think about a typical workday - or, if you're assessing a specific task or activity, the part of the workday when you're performing that task. How much time do you spend leaning or resting part of your body on sharp objects or edges?",
      "options": {
    ...
    "question-13": {
      "label": "Please think about the types of tools or objects you hold for more than 30 minutes at a time. Using the list of descriptions below, select all the statements that apply to these items.\n\nThe last option cannot be selected if any other options have been ticked.",
      "options": {
    ...
    "question-14": {
      "label": "Do you use any body part as a makeshift tool to complete your work? (For example, you might use your palm or knee to apply force to a surface.)\n\nThe illustration below is an example of using your body in this way.",
      "options": {
    ...
    "question-15": {
      "label": "Think about the types of surfaces you push, pull, or move objects across during the job, task, or work activity you are assessing today. Using the list of descriptions below, select all the statements that apply to these surfaces.",
      "options": {
    ...
    "question-18": {
      "label": "Do any of the tools and/or equipment you use require a lot of force to start? (e.g., a lawnmower with a cord you need to yank or a pedal you need to firmly depress)",
      "options": {
    ...
    "question-20": {
      "label": "Think about a typical workday - or, if you're assessing a specific task or activity, the part of the workday when you're performing that task. When either sitting or standing, how often do you work with your upper body leaning forward, backward, or sideways?\n\nPlease select the options that apply to you.",
      "groups": {
        "forward_backward": {
    ...
    "question-22": {
      "label": "Thinking about a typical workday - or, if you're assessing a specific task or activity, the part of the workday when you're performing that task. When either sitting or standing, please indicate where your hands are located in relation to your body.\n\nPlease select the options that apply to you.",
      "groups": {
    ...
    "question-29": {
      "label": "Think about a typical workday - or, if you're assessing a specific task or activity, the part of the workday when you're performing that task. How much time do you spend performing similar movements over and over?",
      "options": {
        "less_than_30_min": "Less than 30 minutes a day",
    ...
    "question-33": {
      "label": "When you grasp an object between your thumb and fingertips, it's called a pinch grip. When you're doing the job, task, or work activity you're assessing today, how much time do you spend using a pinch grip to hold an object that's heavier than 2 pounds / 1 kg?",
      "options": {
    ...
    "question-34": {
      "label": "When you wrap your hand around an object to hold it, it's called a power grip. How much time do you spend using a power grip to hold an object that's heavier than 10 pounds / 4.5 kg?",
      "options": {
        "less_than_2_hours": "Less than 2 hours a day",
        "more_than_2_hours": "More than 2 hours a day",
        "none": "No time at all"
    ...
    "question-36": {
      "label": "If you push or pull any items that are heavier than 80 pounds / 36 kg, how much time do you spend moving these items over rough surfaces (like gravel, tile, or uneven ground) or soft surfaces (like sand, mud, or grass)?",
      "options": {
        "less_than_5_min": "Less than 5 minutes a day",
    ...
    "question-37": {
      "label": "Think about a typical workday - or, if you're assessing a specific task or activity, the part of the workday when you're performing that task. Are you ever distracted by noises (sirens, loud talking, traffic, etc.)?",
      "options": {
