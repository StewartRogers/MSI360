...
export const zhHans: Translation = {
  ...
  questions: {
    ...
    "question-10": {
      label: "请使用下表说明，在执行正在评估的工作或任务期间或之后，你在哪些具体身体部位经历过与工作有关的疼痛或不适。\n\n请说明 a) 身体一侧或两侧是否受影响，以及 b) 疼痛是否持续2天或更久。",
      groups: {
        neck: {
          label: "1. é¢ˆéƒ¨",
          options: {
    ...
    "question-11": {
      label: "想一想典型工作日，或者如果你正在评估某个具体任务或活动，就想一想你执行该任务的那段工作时间。你有多少时间会把身体某部分靠在或压在尖锐物体或边缘上？",
      options: {
    ...
    "question-13": {
      label: "请想一想你一次会握持超过30分钟的工具或物体类型。请从以下描述中选择所有适用项。\n\n如果已勾选其他选项，则不能选择最后一个选项。",
      options: {
    ...
    "question-14": {
      label: "你是否使用身体某个部位作为临时工具来完成工作？例如，你可能用手掌或膝盖向某个表面施加力量。\n\n下图展示了以这种方式使用身体的例子。",
      options: {
    ...
    "question-15": {
      label: "想一想你在今天评估的工作、任务或活动中推动、拉动或移动物体所经过的表面类型。请从以下描述中选择所有适用项。",
      options: {
    ...
    "question-20": {
      label: "想一想典型工作日，或者如果你正在评估某个具体任务或活动，就想一想你执行该任务的那段工作时间。坐着或站着时，你多久会让上半身向前、向后或向侧面倾斜来工作？\n\n请选择适用于你的选项。",
      groups: {
        forward_backward: {
          label: "我向前或向后倾斜超过15度",
          options: {
    ...
    "question-22": {
      label: "想一想典型工作日，或者如果你正在评估某个具体任务或活动，就想一想你执行该任务的那段工作时间。坐着或站着时，请说明你的手相对于身体的位置。\n\n请选择适用于你的选项。",
      groups: {
    ...
    "question-29": {
      label: "想一想典型工作日，或者如果你正在评估某个具体任务或活动，就想一想你执行该任务的那段工作时间。你有多少时间在一遍又一遍地做类似动作？",
      options: {
        less_than_30_min: "每天少于30分钟",
    ...
    "question-33": {
      label: "当你用拇指和指尖夹住物体时，这称为捏握。进行今天评估的工作、任务或活动时，你有多少时间用捏握方式握住超过2磅 / 1公斤的物体？",
      options: {
    ...
    "question-34": {
      label: "当你用手包住物体来握持时，这称为强力握持。你有多少时间用强力握持方式握住超过10磅 / 4.5公斤的物体？",
      options: {
        less_than_2_hours: "每天少于2小时",
        more_than_2_hours: "每天超过2小时",
        none: "完全没有"
    ...
    "question-36": {
      label: "如果你推动或拉动超过80磅 / 36公斤的物品，你有多少时间在粗糙表面（如碎石、瓷砖或不平地面）或柔软表面（如沙地、泥地或草地）上移动这些物品？",
      options: {
        less_than_5_min: "每天少于5分钟",
    ...
    "question-37": {
      label: "想一想典型工作日，或者如果你正在评估某个具体任务或活动，就想一想你执行该任务的那段工作时间。你是否会被噪音分散注意力，例如警报声、大声说话、交通噪音等？",
      options: {
        frequently: "经常",
        sometimes: "有时",
        no: "不会"
