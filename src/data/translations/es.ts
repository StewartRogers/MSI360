...
export const es: Translation = {
  ...
  questions: {
    ...
    "question-3": {
      ...
      help_text: "Proporciona una breve descripción de la tarea o actividad específica que deseas evaluar, incluyendo detalles como postura, molestias, ergonomía del puesto de trabajo y/o duración de los descansos cuando corresponda."
    },
    "question-4": {
    ...
    "question-10": {
      label: "Usando la tabla a continuación, indica las partes específicas del cuerpo donde has tenido dolor o molestia relacionados con el trabajo durante o después de realizar el trabajo o la tarea que se está evaluando.\n\nIndica si a) estuvo afectado uno o ambos lados del cuerpo, y b) el dolor duró 2 días o más.",
      groups: {
        neck: {
          label: "1. Cuello",
          options: {
        ...
        shoulders_upper_arms: {
          label: "2. Hombros o parte superior de los brazos",
          options: {
            one_side: "Dolor o molestia en un lado, por ejemplo el lado izquierdo o derecho del cuerpo",
            both_sides: "Dolor o molestia en ambos lados, izquierdo y derecho",
            lasted_two_days: "El dolor ha durado 2 días o más"
        ...
        lower_back: {
          label: "5. Parte baja de la espalda",
          options: {
            one_side: "Dolor o molestia en un lado, por ejemplo el lado izquierdo o derecho del cuerpo",
            both_sides: "Dolor o molestia en ambos lados, izquierdo y derecho",
            lasted_two_days: "El dolor ha durado 2 días o más"
        ...
        hips_upper_legs: {
          label: "6. Caderas o parte superior de las piernas, muslos",
          options: {
            one_side: "Dolor o molestia en un lado, por ejemplo el lado izquierdo o derecho del cuerpo",
            both_sides: "Dolor o molestia en ambos lados, izquierdo y derecho",
            lasted_two_days: "El dolor ha durado 2 días o más"
        ...
        knees_lower_legs: {
          label: "7. Rodillas o parte inferior de las piernas, pantorrillas",
          options: {
            one_side: "Dolor o molestia en un lado, por ejemplo el lado izquierdo o derecho del cuerpo",
            both_sides: "Dolor o molestia en ambos lados, izquierdo y derecho",
            lasted_two_days: "El dolor ha durado 2 días o más"
    ...
    "question-11": {
      label: "Piensa en un día laboral típico o, si estás evaluando una tarea o actividad específica, en la parte del día en que realizas esa tarea. ¿Cuánto tiempo pasas inclinándote o apoyando parte de tu cuerpo sobre objetos o bordes afilados?",
      options: {
    ...
    "question-13": {
      label: "Piensa en los tipos de herramientas u objetos que sostienes durante más de 30 minutos seguidos. Usando la lista de descripciones a continuación, selecciona todas las afirmaciones que correspondan a estos elementos.\n\nLa última opción no puede seleccionarse si se marcó alguna otra opción.",
      options: {
    ...
    "question-14": {
      label: "¿Usas alguna parte de tu cuerpo como herramienta improvisada para completar tu trabajo? Por ejemplo, podrías usar la palma de la mano o la rodilla para aplicar fuerza sobre una superficie.\n\nLa ilustración a continuación muestra un ejemplo de usar el cuerpo de esta manera.",
      options: {
    ...
    "question-15": {
      label: "Piensa en los tipos de superficies sobre las que empujas, jalas o mueves objetos durante el trabajo, tarea o actividad laboral que estás evaluando hoy. Usando la lista de descripciones a continuación, selecciona todas las afirmaciones que correspondan a estas superficies.",
      options: {
    ...
    "question-20": {
      label: "Piensa en un día laboral típico o, si estás evaluando una tarea o actividad específica, en la parte del día en que realizas esa tarea. Al estar sentado o de pie, ¿con qué frecuencia trabajas con la parte superior del cuerpo inclinada hacia adelante, hacia atrás o hacia un lado?\n\nSelecciona las opciones que correspondan.",
      groups: {
        forward_backward: {
          label: "Me inclino hacia adelante o hacia atrás más de 15 grados",
          options: {
            most: "La mayor parte del tiempo",
            some: "Parte del tiempo",
            never: "Nunca"
        ...
        sideways: {
          label: "Me inclino hacia un lado",
          options: {
            most: "La mayor parte del tiempo",
            some: "Parte del tiempo",
            never: "Nunca"
    ...
    "question-22": {
      label: "Piensa en un día laboral típico o, si estás evaluando una tarea o actividad específica, en la parte del día en que realizas esa tarea. Al estar sentado o de pie, indica dónde se encuentran tus manos en relación con tu cuerpo.\n\nSelecciona las opciones que correspondan.",
      groups: {
        hands_above_shoulders: {
          label: "Manos por encima de los hombros",
          options: {
            most: "La mayor parte del tiempo",
            some: "Parte del tiempo",
            never: "Nunca"
        ...
        hands_floor_to_knee: {
          label: "Manos entre el piso y la rodilla",
          options: {
            most: "La mayor parte del tiempo",
            some: "Parte del tiempo",
            never: "Nunca"
    ...
    "question-29": {
      label: "Piensa en un día laboral típico o, si estás evaluando una tarea o actividad específica, en la parte del día en que realizas esa tarea. ¿Cuánto tiempo pasas realizando movimientos similares una y otra vez?",
      options: {
        less_than_30_min: "Menos de 30 minutos al día",
    ...
    "question-33": {
      label: "Cuando sujetas un objeto entre el pulgar y las puntas de los dedos, se llama agarre de pinza. Al hacer el trabajo, tarea o actividad laboral que estás evaluando hoy, ¿cuánto tiempo pasas usando un agarre de pinza para sostener un objeto que pesa más de 2 lb / 1 kg?",
      options: {
    ...
    "question-34": {
      label: "Cuando rodeas un objeto con la mano para sostenerlo, se llama agarre de fuerza. ¿Cuánto tiempo pasas usando un agarre de fuerza para sostener un objeto que pesa más de 10 lb / 4.5 kg?",
      options: {
        less_than_2_hours: "Menos de 2 horas al día",
        more_than_2_hours: "Más de 2 horas al día",
        none: "Nada de tiempo"
    ...
    "question-36": {
      label: "Si empujas o jalas objetos que pesan más de 80 lb / 36 kg, ¿cuánto tiempo pasas moviéndolos sobre superficies ásperas, como grava, baldosa o terreno irregular, o superficies blandas, como arena, lodo o césped?",
      options: {
        less_than_5_min: "Menos de 5 minutos al día",
    ...
    "question-37": {
      label: "Piensa en un día laboral típico o, si estás evaluando una tarea o actividad específica, en la parte del día en que realizas esa tarea. ¿Alguna vez te distraen ruidos, como sirenas, conversaciones fuertes, tráfico, etc.?",
      options: {
