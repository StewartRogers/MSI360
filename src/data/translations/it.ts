...
export const it: Translation = {
  app: {
    ...
    description_body:
      "Le domande seguenti riguardano il lavoro che svolgi durante una giornata lavorativa tipica, oppure mentre completi l'attivita o il compito specifico che desideri valutare oggi. L'intento e comunicare a MSI360 le azioni che esegui per portare a termine il tuo lavoro."
  },
  sections: {
  ...
  questions: {
    ...
    "question-10": {
      label:
        "Usando la tabella seguente, indica le parti specifiche del corpo in cui hai provato dolore o fastidio correlato al lavoro durante o dopo il lavoro o compito valutato.\n\nIndica se a) era coinvolto uno o entrambi i lati del corpo, e b) il dolore e durato 2 giorni o piu.",
      groups: {
        neck: { label: "1. Collo", options: bodySideOptions },
        shoulders_upper_arms: { label: "2. Spalle o parte superiore delle braccia", options: bodySideOptions },
        elbows_forearms: { label: "3. Gomiti o avambracci", options: bodySideOptions },
        wrists_hands_fingers: { label: "4. Polsi, mani o dita", options: bodySideOptions },
        lower_back: { label: "5. Parte bassa della schiena", options: bodySideOptions },
        hips_upper_legs: { label: "6. Anche o parte superiore delle gambe", options: bodySideOptions },
        knees_lower_legs: { label: "7. Ginocchia o parte inferiore delle gambe", options: bodySideOptions },
        ankles_feet: { label: "8. Caviglie o piedi", options: bodySideOptions }
      }
    },
    "question-11": {
      label:
        "Pensa a una giornata lavorativa tipica, oppure alla parte della giornata in cui svolgi il compito specifico che stai valutando. Quanto tempo passi appoggiando o premendo una parte del corpo su oggetti o bordi taglienti?",
      options: {
    ...
    "question-13": {
      label:
        "Pensa ai tipi di strumenti o oggetti che tieni in mano per piu di 30 minuti alla volta. Dall'elenco seguente, seleziona tutte le descrizioni applicabili.\n\nL'ultima opzione non puo essere selezionata se e stata selezionata qualsiasi altra opzione.",
      options: {
    ...
    "question-14": {
      label:
        "Usi una parte del corpo come strumento improvvisato per completare il lavoro? Per esempio, potresti usare il palmo o il ginocchio per applicare forza su una superficie.\n\nL'immagine sotto mostra un esempio di questo tipo di uso del corpo.",
      options: {
    ...
    "question-15": {
      label:
        "Pensa ai tipi di superfici su cui spingi, tiri o sposti oggetti durante il lavoro, compito o attivita che stai valutando oggi. Seleziona tutte le descrizioni applicabili.",
      options: {
    ...
    "question-20": {
      label:
        "Pensa a una giornata lavorativa tipica, oppure alla parte della giornata in cui svolgi il compito specifico che stai valutando. Quando sei seduto o in piedi, quanto spesso lavori con la parte superiore del corpo inclinata in avanti, indietro o lateralmente?\n\nSeleziona le opzioni applicabili.",
      groups: {
        forward_backward: { label: "Mi inclino in avanti o indietro di oltre 15 gradi", options: mostSomeNeverOptions },
        sideways: { label: "Mi inclino lateralmente", options: mostSomeNeverOptions }
      }
    },
    "question-21": {
    ...
    "question-22": {
      label:
        "Pensa a una giornata lavorativa tipica, oppure alla parte della giornata in cui svolgi il compito specifico che stai valutando. Quando sei seduto o in piedi, indica dove si trovano le mani rispetto al corpo.\n\nSeleziona le opzioni applicabili.",
      groups: {
        hands_above_shoulders: { label: "Mani sopra le spalle", options: mostSomeNeverOptions },
        hands_floor_to_knee: { label: "Mani tra il pavimento e il ginocchio", options: mostSomeNeverOptions }
      }
    },
    "question-23": {
    ...
    "question-29": {
      label:
        "Pensa a una giornata lavorativa tipica, oppure alla parte della giornata in cui svolgi il compito specifico che stai valutando. Quanto tempo passi a eseguire movimenti simili ripetutamente?",
      options: {
        less_than_30_min: "Meno di 30 minuti al giorno",
    ...
    "question-33": {
      label:
        "Quando afferri un oggetto tra pollice e punte delle dita, si chiama presa a pinza. Durante il lavoro, compito o attivita che stai valutando oggi, quanto tempo passi usando una presa a pinza per tenere un oggetto piu pesante di 2 libbre / 1 kg?",
      options: {
    ...
    "question-34": {
      label:
        "Quando avvolgi la mano attorno a un oggetto per tenerlo, si chiama presa di forza. Quanto tempo passi usando una presa di forza per tenere un oggetto piu pesante di 10 libbre / 4,5 kg?",
      options: {
        less_than_2_hours: "Meno di 2 ore al giorno",
        more_than_2_hours: "Piu di 2 ore al giorno",
        none: "Nessun tempo"
    ...
    "question-36": {
      label:
        "Se spingi o tiri oggetti piu pesanti di 80 libbre / 36 kg, quanto tempo passi a spostarli su superfici ruvide, come ghiaia, piastrelle o terreno irregolare, oppure morbide, come sabbia, fango o erba?",
      options: {
        less_than_5_min: "Meno di 5 minuti al giorno",
    ...
    "question-37": {
      label:
        "Pensa a una giornata lavorativa tipica, oppure alla parte della giornata in cui svolgi il compito specifico che stai valutando. Ti capita di essere distratto da rumori, come sirene, conversazioni ad alto volume, traffico, ecc.?",
      options: {
        frequently: "Frequentemente",
        sometimes: "A volte",
        no: "No"
