...
export const de: Translation = {
  ...
  "questions": {
    ...
    "question-10": {
      "label": "Bitte geben Sie in der folgenden Tabelle die Körperbereiche an, in denen Sie während oder nach der zu bewertenden Arbeit oder Aufgabe arbeitsbedingte Schmerzen oder Beschwerden hatten.\n\nGeben Sie an, ob a) eine oder beide Körperseiten betroffen waren und b) die Schmerzen 2 oder mehr Tage anhielten.",
      "groups": {
        "neck": {
          "label": "1. Nacken",
          "options": {
        ...
        "shoulders_upper_arms": {
          "label": "2. Schulter(n) oder Oberarm/Oberarme",
          "options": {
            "one_side": "Schmerzen oder Beschwerden auf einer Körperseite, z. B. links oder rechts",
            "both_sides": "Schmerzen oder Beschwerden auf der linken und rechten Seite",
            "lasted_two_days": "Die Schmerzen dauerten 2 oder mehr Tage an"
        ...
        "elbows_forearms": {
          "label": "3. Ellbogen oder Unterarm/Unterarme",
          "options": {
            "one_side": "Schmerzen oder Beschwerden auf einer Körperseite, z. B. links oder rechts",
            "both_sides": "Schmerzen oder Beschwerden auf der linken und rechten Seite",
            "lasted_two_days": "Die Schmerzen dauerten 2 oder mehr Tage an"
        ...
        "wrists_hands_fingers": {
          "label": "4. Handgelenk(e), Hand/Hände oder Finger",
          "options": {
            "one_side": "Schmerzen oder Beschwerden auf einer Körperseite, z. B. links oder rechts",
            "both_sides": "Schmerzen oder Beschwerden auf der linken und rechten Seite",
            "lasted_two_days": "Die Schmerzen dauerten 2 oder mehr Tage an"
        ...
        "hips_upper_legs": {
          "label": "6. Hüfte(n) oder Oberschenkel",
          "options": {
            "one_side": "Schmerzen oder Beschwerden auf einer Körperseite, z. B. links oder rechts",
            "both_sides": "Schmerzen oder Beschwerden auf der linken und rechten Seite",
            "lasted_two_days": "Die Schmerzen dauerten 2 oder mehr Tage an"
        ...
        "knees_lower_legs": {
          "label": "7. Knie oder Unterschenkel",
          "options": {
            "one_side": "Schmerzen oder Beschwerden auf einer Körperseite, z. B. links oder rechts",
            "both_sides": "Schmerzen oder Beschwerden auf der linken und rechten Seite",
            "lasted_two_days": "Die Schmerzen dauerten 2 oder mehr Tage an"
    ...
    "question-11": {
      "label": "Denken Sie an einen typischen Arbeitstag oder, wenn Sie eine konkrete Aufgabe oder Tätigkeit bewerten, an den Teil des Arbeitstags, in dem Sie diese Aufgabe ausführen. Wie viel Zeit verbringen Sie damit, einen Körperteil auf scharfe Gegenstände oder Kanten zu lehnen oder darauf abzustützen?",
      "options": {
    ...
    "question-13": {
      "label": "Denken Sie an die Arten von Werkzeugen oder Gegenständen, die Sie jeweils länger als 30 Minuten halten. Wählen Sie aus der folgenden Liste alle Aussagen aus, die auf diese Gegenstände zutreffen.\n\nDie letzte Option kann nicht ausgewählt werden, wenn eine andere Option angekreuzt wurde.",
      "options": {
    ...
    "question-14": {
      "label": "Verwenden Sie irgendeinen Körperteil als behelfsmäßiges Werkzeug, um Ihre Arbeit zu erledigen? Zum Beispiel könnten Sie mit Ihrer Handfläche oder Ihrem Knie Kraft auf eine Oberfläche ausüben.\n\nDie folgende Abbildung zeigt ein Beispiel für diese Art der Körpernutzung.",
      "options": {
    ...
    "question-15": {
      "label": "Denken Sie an die Arten von Oberflächen, über die Sie während der heute bewerteten Arbeit, Aufgabe oder Tätigkeit Gegenstände schieben, ziehen oder bewegen. Wählen Sie aus der folgenden Liste alle Aussagen aus, die auf diese Oberflächen zutreffen.",
      "options": {
    ...
    "question-20": {
      "label": "Denken Sie an einen typischen Arbeitstag oder, wenn Sie eine konkrete Aufgabe oder Tätigkeit bewerten, an den Teil des Arbeitstags, in dem Sie diese Aufgabe ausführen. Wie oft arbeiten Sie im Sitzen oder Stehen mit nach vorne, hinten oder zur Seite geneigtem Oberkörper?\n\nBitte wählen Sie die Optionen aus, die auf Sie zutreffen.",
      "groups": {
        "forward_backward": {
          "label": "Ich neige mich mehr als 15 Grad nach vorne oder hinten",
          "options": {
            "most": "Die meiste Zeit",
            "some": "Einen Teil der Zeit",
            "never": "Nie"
        ...
        "sideways": {
          "label": "Ich neige mich zur Seite",
          "options": {
            "most": "Die meiste Zeit",
            "some": "Einen Teil der Zeit",
            "never": "Nie"
    ...
    "question-22": {
      "label": "Denken Sie an einen typischen Arbeitstag oder, wenn Sie eine konkrete Aufgabe oder Tätigkeit bewerten, an den Teil des Arbeitstags, in dem Sie diese Aufgabe ausführen. Geben Sie beim Sitzen oder Stehen an, wo sich Ihre Hände im Verhältnis zu Ihrem Körper befinden.\n\nBitte wählen Sie die Optionen aus, die auf Sie zutreffen.",
      "groups": {
        "hands_above_shoulders": {
          "label": "Hände oberhalb der Schultern",
          "options": {
            "most": "Die meiste Zeit",
            "some": "Einen Teil der Zeit",
            "never": "Nie"
        ...
        "hands_floor_to_knee": {
          "label": "Hände zwischen Boden und Knie",
          "options": {
            "most": "Die meiste Zeit",
            "some": "Einen Teil der Zeit",
            "never": "Nie"
    ...
    "question-29": {
      "label": "Denken Sie an einen typischen Arbeitstag oder, wenn Sie eine konkrete Aufgabe oder Tätigkeit bewerten, an den Teil des Arbeitstags, in dem Sie diese Aufgabe ausführen. Wie viel Zeit verbringen Sie mit wiederholten ähnlichen Bewegungen?",
      "options": {
        "less_than_30_min": "Weniger als 30 Minuten pro Tag",
    ...
    "question-33": {
      "label": "Wenn Sie einen Gegenstand zwischen Daumen und Fingerspitzen greifen, nennt man das Pinzettengriff. Wie viel Zeit verbringen Sie bei der heute bewerteten Arbeit, Aufgabe oder Tätigkeit damit, einen Gegenstand, der schwerer als 2 Pfund / 1 kg ist, mit einem Pinzettengriff zu halten?",
      "options": {
    ...
    "question-37": {
      "label": "Denken Sie an einen typischen Arbeitstag oder, wenn Sie eine konkrete Aufgabe oder Tätigkeit bewerten, an den Teil des Arbeitstags, in dem Sie diese Aufgabe ausführen. Werden Sie manchmal durch Geräusche abgelenkt (Sirenen, lautes Sprechen, Verkehr usw.)?",
      "options": {
        "frequently": "Häufig",
        "sometimes": "Manchmal",
        "no": "Nein"
