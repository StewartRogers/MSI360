...
export const ja: Translation = {
  app: {
    ...
    complete_start_new: "新しい評価を開始",    description_title: "説明",
    description_body:
      "以下の質問は、通常の勤務日、または今日評価したい特定の作業や活動を行うときの仕事内容について尋ねるものです。MSI360に、仕事を完了するために行っている動作を伝えることが目的です。"
  },
  sections: {
    intro: "作業について",
    symptoms: "現在の症状",
  ...
  questions: {
    ...
    "question-10": {
      label:
        "下の表を使って、評価対象の仕事または作業を行っている最中または後に、仕事に関連した痛みや不快感を経験した体の部位を示してください。\n\na) 体の片側または両側が関係していたか、b) 痛みが2日以上続いたかを示してください。",
      groups: {
        neck: { label: "1. é¦–", options: bodySideOptions },
        shoulders_upper_arms: { label: "2. 肩または上腕", options: bodySideOptions },
        elbows_forearms: { label: "3. 肘または前腕", options: bodySideOptions },
        wrists_hands_fingers: { label: "4. 手首、手、または指", options: bodySideOptions },
        lower_back: { label: "5. 腰", options: bodySideOptions },
        hips_upper_legs: { label: "6. 股関節または太もも", options: bodySideOptions },
        knees_lower_legs: { label: "7. 膝または下腿", options: bodySideOptions },
        ankles_feet: { label: "8. 足首または足", options: bodySideOptions }
      }
    },
    "question-11": {
      label:
        "通常の勤務日、または特定の作業や活動を評価している場合はその作業を行う時間帯を考えてください。体の一部を鋭い物や端に寄りかけたり、もたれかけたりする時間はどのくらいありますか？",
      options: {
    ...
    "question-13": {
      label:
        "一度に30分を超えて持つ工具や物の種類を考えてください。以下の説明のうち、該当するものをすべて選択してください。\n\n他の選択肢にチェックが入っている場合、最後の選択肢は選択できません。",
      options: {
    ...
    "question-14": {
      label:
        "作業を完了するために、体の一部を即席の工具のように使うことがありますか？ たとえば、手のひらや膝で表面に力を加える場合などです。\n\n下の図は、このように体を使う例です。",
      options: {
    ...
    "question-15": {
      label:
        "今日評価している仕事、作業、または活動で、物を押す、引く、移動させる表面の種類を考えてください。以下の説明のうち、該当するものをすべて選択してください。",
      options: {
        smooth: "滑らか（例: 仕上げ面）",
        soft: "柔らかい（例: 砂、泥、草）",
    ...
    "question-20": {
      label:
        "通常の勤務日、または特定の作業や活動を評価している場合はその作業を行う時間帯を考えてください。座っている、または立っているとき、上半身を前、後ろ、または横に傾けて作業する頻度はどのくらいですか？\n\n該当する選択肢を選んでください。",
      groups: {
        forward_backward: { label: "上半身を前または後ろに15度以上傾ける", options: mostSomeNeverOptions },
        sideways: { label: "上半身を横に傾ける", options: mostSomeNeverOptions }
      }
    },
    "question-21": {
    ...
    "question-22": {
      label:
        "通常の勤務日、または特定の作業や活動を評価している場合はその作業を行う時間帯を考えてください。座っている、または立っているとき、手が体に対してどの位置にあるかを示してください。\n\n該当する選択肢を選んでください。",
      groups: {
        hands_above_shoulders: { label: "手が肩より上にある", options: mostSomeNeverOptions },
        hands_floor_to_knee: { label: "手が床から膝の間にある", options: mostSomeNeverOptions }
      }
    },
    "question-23": {
    ...
    "question-29": {
      label:
        "通常の勤務日、または特定の作業や活動を評価している場合はその作業を行う時間帯を考えてください。同じような動作を何度も繰り返す時間はどのくらいありますか？",
      options: {
        less_than_30_min: "1日30分未満",
    ...
    "question-33": {
      label:
        "親指と指先で物をつかむことをピンチグリップと呼びます。今日評価している仕事、作業、または活動中に、2ポンド / 1 kgを超える物をピンチグリップで持つ時間はどのくらいありますか？",
      options: {
    ...
    "question-34": {
      label:
        "手を物の周りに回して持つことをパワーグリップと呼びます。10ポンド / 4.5 kgを超える物をパワーグリップで持つ時間はどのくらいありますか？",
      options: {
        less_than_2_hours: "1日2時間未満",
        more_than_2_hours: "1日2時間超",
        none: "まったくない"
    ...
    "question-36": {
      label:
        "80ポンド / 36 kgを超える物を押したり引いたりする場合、砂利、タイル、不整地などの粗い表面、または砂、泥、草などの柔らかい表面の上でそれらを移動させる時間はどのくらいありますか？",
      options: {
        less_than_5_min: "1日5分未満",
    ...
    "question-37": {
      label:
        "通常の勤務日、または特定の作業や活動を評価している場合はその作業を行う時間帯を考えてください。騒音（サイレン、大声での会話、交通音など）で気が散ることがありますか？",
      options: {
        frequently: "頻繁に",
        sometimes: "ときどき",
        no: "いいえ"
