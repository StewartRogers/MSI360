...
export const pl: Translation = {
  app: {
    ...
    description_body:
      "Ponizsze pytania dotycza pracy wykonywanej podczas typowego dnia pracy albo podczas wykonywania konkretnego zadania lub czynnosci, ktore chcesz dzis ocenic. Celem jest przekazanie MSI360 informacji o czynnosciach, ktore wykonujesz, aby zrealizowac swoja prace."
  },
  sections: {
    intro: "O pracy",
  ...
  questions: {
    ...
    "question-10": {
      label:
        "Korzystajac z ponizszej tabeli, wskaz konkretne czesci ciala, w ktorych doswiadczyles bolu lub dyskomfortu zwiazanego z praca podczas lub po wykonywaniu ocenianej pracy albo zadania.\n\nWskaz, czy a) dotyczylo to jednej lub obu stron ciala oraz b) czy bol trwal 2 dni lub dluzej.",
      groups: {
        neck: { label: "1. Szyja", options: bodySideOptions },
        shoulders_upper_arms: { label: "2. Barki lub ramiona", options: bodySideOptions },
        elbows_forearms: { label: "3. Lokcie lub przedramiona", options: bodySideOptions },
        wrists_hands_fingers: { label: "4. Nadgarstki, dlonie lub palce", options: bodySideOptions },
        lower_back: { label: "5. Dolna czesc plecow", options: bodySideOptions },
        hips_upper_legs: { label: "6. Biodra lub uda", options: bodySideOptions },
        knees_lower_legs: { label: "7. Kolana lub podudzia", options: bodySideOptions },
        ankles_feet: { label: "8. Kostki lub stopy", options: bodySideOptions }
      }
    },
    "question-11": {
      label:
        "Pomysl o typowym dniu pracy albo, jesli oceniasz konkretne zadanie lub czynnosc, o tej czesci dnia, w ktorej je wykonujesz. Ile czasu spedzasz, opierajac czesc ciala o ostre przedmioty lub krawedzie?",
      options: {
    ...
    "question-13": {
      label:
        "Pomysl o typach narzedzi lub przedmiotow, ktore trzymasz przez ponad 30 minut naraz. Z ponizszej listy wybierz wszystkie pasujace opisy.\n\nOstatniej opcji nie mozna wybrac, jesli zaznaczono jakakolwiek inna opcje.",
      options: {
    ...
    "question-14": {
      label:
        "Czy uzywasz jakiejkolwiek czesci ciala jako prowizorycznego narzedzia do wykonania pracy? Na przyklad mozesz uzywac dloni lub kolana, aby wywierac nacisk na powierzchnie.\n\nIlustracja ponizej pokazuje przyklad takiego uzycia ciala.",
      options: {
    ...
    "question-15": {
      label:
        "Pomysl o rodzajach powierzchni, po ktorych pchasz, ciagniesz lub przesuwasz przedmioty podczas ocenianej pracy, zadania lub czynnosci. Wybierz wszystkie pasujace opisy.",
      options: {
    ...
    "question-20": {
      label:
        "Pomysl o typowym dniu pracy albo o czesci dnia, w ktorej wykonujesz oceniane zadanie. Jak czesto podczas siedzenia lub stania pracujesz z gorna czescia ciala pochylona do przodu, do tylu lub na bok?\n\nWybierz opcje, ktore Ciebie dotycza.",
      groups: {
        forward_backward: { label: "Pochylam sie do przodu lub do tylu o ponad 15 stopni", options: mostSomeNeverOptions },
        sideways: { label: "Pochylam sie na bok", options: mostSomeNeverOptions }
      }
    },
    "question-21": {
    ...
    "question-22": {
      label:
        "Pomysl o typowym dniu pracy albo o czesci dnia, w ktorej wykonujesz oceniane zadanie. Podczas siedzenia lub stania wskaz, gdzie znajduja sie Twoje rece wzgledem ciala.\n\nWybierz opcje, ktore Ciebie dotycza.",
      groups: {
        hands_above_shoulders: { label: "Rece powyzej barkow", options: mostSomeNeverOptions },
        hands_floor_to_knee: { label: "Rece miedzy podloga a kolanem", options: mostSomeNeverOptions }
      }
    },
    "question-23": {
    ...
    "question-29": {
      label:
        "Pomysl o typowym dniu pracy albo o czesci dnia, w ktorej wykonujesz oceniane zadanie. Ile czasu spedzasz na wykonywaniu podobnych ruchow w kolko?",
      options: {
        less_than_30_min: "Mniej niz 30 minut dziennie",
    ...
    "question-33": {
      label:
        "Gdy chwytasz przedmiot miedzy kciukiem a opuszkami palcow, nazywa sie to chwytem szczypcowym. Podczas ocenianej pracy, zadania lub czynnosci, ile czasu spedzasz, uzywajac chwytu szczypcowego do trzymania przedmiotu ciezszego niz 2 funty / 1 kg?",
      options: {
    ...
    "question-34": {
      label:
        "Gdy obejmujesz dlonia przedmiot, aby go trzymac, nazywa sie to chwytem silowym. Ile czasu spedzasz, uzywajac chwytu silowego do trzymania przedmiotu ciezszego niz 10 funtow / 4,5 kg?",
      options: {
        less_than_2_hours: "Mniej niz 2 godziny dziennie",
        more_than_2_hours: "Ponad 2 godziny dziennie",
        none: "Wcale"
    ...
    "question-36": {
      label:
        "Jesli pchasz lub ciagniesz przedmioty ciezsze niz 80 funtow / 36 kg, ile czasu spedzasz na przesuwaniu ich po szorstkich powierzchniach, takich jak zwir, plytki lub nierowny grunt, albo po miekkich powierzchniach, takich jak piasek, bloto lub trawa?",
      options: {
        less_than_5_min: "Mniej niz 5 minut dziennie",
    ...
    "question-37": {
      label:
        "Pomysl o typowym dniu pracy albo o czesci dnia, w ktorej wykonujesz oceniane zadanie. Czy kiedykolwiek rozpraszaja Cie halasy, takie jak syreny, glosne rozmowy, ruch uliczny itd.?",
      options: {
        frequently: "Czesto",
        sometimes: "Czasami",
        no: "Nie"
